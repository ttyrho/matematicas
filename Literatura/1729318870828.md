...
Se denomina **adjunto** o **cofactor** del elemento $a_{ij}$ de $A$ al escalar $$\alpha_{ij} = (-1)^{ij}det(A_{ij})$$ de manera que $$det(A) = \sum_{i=1}^{n} a_{i1}\alpha_{i1} = a_{11}\alpha_{11}

...
:multiline-flashcard:
**Solución 1**: Sean $A$ y $B$ matrices cuadradas de orden $n$ tales que $rg(A+B) = rg(A-B) = 0$. Como la única matriz que tiene rango cero es la matriz nula, entonces $A+B = A-B = 0$. De donde 
